...
ITEM_ADDED_MESSAGE = (
    'Товар <b>{name}</b> успешно добавлен. Текущая цена товара - '
    '<b>{price} ₽</b>\nКак только стоимость товара достигнет желаемой цены, '
    'Вам будет направлено уведомление.'
)
...
ERROR_ADD_ITEM_MESSAGE = 'Не получилось добавить товар'
